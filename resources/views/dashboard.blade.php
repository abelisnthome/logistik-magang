          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <div class="progress-group">
                      Alat Tulis Kantor
                      <span class="float-right"><b>{{ $atknow }}</b>/{{ $totalatk }}</span>
                    ...
                    <div class="progress-group">
                      IT
                      <span class="float-right"><b>{{$itnow}}</b>/{{$totalit}}</span>
                      <div class="progress progress-sm">
                    ...
                    <div class="progress-group">
                      Elektronik
                      <span class="float-right"><b>{{$eleknow}}</b>/{{$totalelek}}</span>
                      <div class="progress progress-sm">
                    ...
                    <div class="progress-group">
                      ...
                      <span class="float-right"><b>{{$lainnow}}</b>/{{$totallain}}</span>
                      <div class="progress progress-sm">
                  ...
                  <li class="item">
                    ...
                    <div class="product-info">
                      <a href="javascript:void(0)" class="product-title">{{ $bm->nama_brg }}
                        <span class="badge badge-info float-right">{{ $bm->jmlh_brg }}</span></a>
